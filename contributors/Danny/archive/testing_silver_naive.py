...
network_directory = get_parent_path('data', subdirectory = 'Spike Ripples/silver/RippleNet_tuned_naive_128_epochs')
figure_directory ='figures/LOO_tuning_naive_128_epochs/'
